...
CREATE DATABASE bootcamp WITH OWNER postgres;
...
VALUES (
    ...
    (
        'Amelia',
        'Dux',
        to_date('07/04/1996', 'DD/MM/YYYY')
    ),
    (
        'David',
        'Grez',
        to_date('14/06/2003', 'DD/MM/YYYY')
    ),
    (
        'Omer',
        'Simpson',
        to_date('03/10/1980', 'DD/MM/YYYY')
    ),
    (
        'Yao',
        'Yann',
        to_date('22/10/2002', 'DD/MM/YYYY')
    );
